            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    href="mailto:efetip@efetip.com.tr?subject=AQURE POC IT Fiyat Teklifi Talebi"
          ...
          <div className="container mx-auto px-4 md:px-6 max-w-7xl">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="mailto:efetip@efetip.com.tr?subject=AQURE POC IT Fiyat Teklifi Talebi&body=Merhaba,%0D%0A%0D%0AAQURE POC IT çözümü hakkında detaylı bilgi ve fiyat teklifi almak istiyorum.%0D%0A%0D%0ATeşekkürler."
